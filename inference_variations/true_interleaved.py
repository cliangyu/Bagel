...
### CODE
# despite their system prompt, if using their inferencer()
# the LLM NEVER generates img_start token with gen_text
prompt = "Generate an image of: 5 trees in an field <|vision_start|>"
print(prompt)
print('-' * 10)
output_dict = inferencer.true_interleave_inference(text=prompt, **t2i_think_params)
# breakpoint()